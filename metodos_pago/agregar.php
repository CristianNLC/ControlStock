...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nombre)) {
        ...
        if ($conexion->connect_error) {
            ...
            $sql = "INSERT INTO metodos_pago (nombre) VALUES (?)";
            ...
            if ($stmt->execute()) {
                ...
                $error = "Error al agregar método de pago: " . $conexion->error;
            }
            $stmt->close();
            $conexion->close();
        }
...
<head>
    ...
    <title>Agregar Método de Pago - Nissi Creaciones</title>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <div class="form-actions">
                    <button type="submit" class="button highlight">Guardar Método</button>
